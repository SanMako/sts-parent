    ...
    plugins: [
      ...
      federation({
        ...
        exposes: {
          ...
          "./StsTextarea": "./src/components/input/index.ts",
          ...
          "./StsTabs": "./src/components/tabs/index.ts",
          "./StsTabPane": "./src/components/tabs/index.ts",
          "./StsProgress": "./src/components/progress/index.ts",
          "./StsTree": "./src/components/tree/index.ts",
          "./StsTreeSelect": "./src/components/tree-select/index.ts",
        },
